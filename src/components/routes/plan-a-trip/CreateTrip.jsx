...
function CreateTrip() {
  ...
  return (
    <div className="mt-10">
      ...
      <h2
  className="text-2xl md:text-4xl font-bold p-4"
  ...
  onMouseLeave={(e) => {
    e.target.style.backgroundColor = '#ec4899'; // Initial background (pink)
    e.target.style.color = 'white'; // Initial text color (white)
  }}
>
  Fill Your Travel Preferences 🌟🚀
</h2>

        <p className="text-sm text-black-600 font-medium mt-3">
        Tell us what you love, and let TourArchitect transform your travel dreams into a perfectly planned itinerary.
        </p>
        <img src="/B.jpeg" className="transition duration-300 hover:brightness-120 hover:contrast-125" alt="" />
      </div>
      ...
      <div className="form mt-10 flex flex-col gap-10 md:gap-20 ">
        <div className="place">
          <h2 className="font-semibold text-md md:text-lg mb-3 text-center md:text-left">
            Where do you want to Navigate? 🏖️
          </h2>
